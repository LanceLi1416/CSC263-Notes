...
\begin{minipage}[t]{0.32\linewidth} \begin{center} \begin{tikzpicture} [
    ...
    \draw[dashed, -latex, color=red!50] (root) to (17);
    \draw[bend right=60, dashed, -latex, color=red!50] (10) to (root);
\end{tikzpicture} \end{center} \end{minipage}
\begin{minipage}[t]{0.32\linewidth} \begin{center} \begin{tikzpicture} [
    every node/.style = {circle, fill=Violet, minimum size=2em}, 
    level 1/.style={sibling distance=6em}, 
    ...
    \draw[bend left=60, dashed, latex-latex, color=red!50] (root) to (16);
\end{tikzpicture} \end{center} \end{minipage}
\begin{minipage}[t]{0.32\linewidth} \begin{center} \begin{tikzpicture} [
    every node/.style = {circle, fill=Violet, minimum size=2em}, 
    level 1/.style={sibling distance=6em}, 
